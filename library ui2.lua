...
menu.outline.outline.main.text.Text = "Sirex Ware V3"
...
function library:addTab(name,Imageid)
    ...
    function tab:createGroup(pos)
        ...
        function group:addToggle(args)
            ...
            checkbox.BackgroundColor3 = Color3.fromRGB(39, 27, 55)
            ...
            box.Parent = checkbox
            box.BackgroundColor3 = Color3.fromRGB(56, 39, 80)
            box.BorderColor3 = Color3.fromRGB(48, 34, 70)
            ...
            function toggle(newState)
                state = newState
                box.BackgroundColor3 = state and library.libColor or Color3.fromRGB(56, 39, 80)
        ...
        function group:addButton(args)
            ...
            button.BackgroundColor3 = Color3.fromRGB(56, 39, 80)
        ...
        function group:addSlider(args)
            ...
            slider_2.BackgroundColor3 = Color3.fromRGB(56, 39, 80)
            slider_2.BorderColor3 = Color3.fromRGB(48, 34, 70)
            ...
            slider_2.Text = ""
            slider_2.TextColor3 = Color3.fromRGB(239, 216, 255)
            ...
            valueText.Text = "0"
            valueText.TextColor3 = Color3.fromRGB(239, 216, 255)
        ...
        function group:addDivider()
            ...
            divider.BackgroundColor3 = Color3.fromRGB(56, 39, 80)
        ...
        function group:addTextbox(args)
            ...
            textbox.BackgroundColor3 = Color3.fromRGB(56, 39, 80)
            textbox.BorderColor3 = Color3.fromRGB(48, 34, 70)
            textbox.Size = UDim2.new(1,-10,0,18)
            textbox.ClearTextOnFocus = false
            textbox.Font = Enum.Font.Arial
            textbox.PlaceholderColor3 = Color3.fromRGB(61, 45, 85)
            textbox.PlaceholderText = args.text or ""
            textbox.Text = ""
            textbox.TextColor3 = Color3.fromRGB(239, 216, 255)
            textbox.TextSize = 16
        ...
        function group:addKeybind(args)
            ...
            newText.Font = "Arial"
            newText.Text = ""
            newText.TextColor3 = Color3.fromRGB(239, 216, 255)
            newText.TextSize = 16
            ...
            text.Parent = button
            text.BackgroundColor3 = Color3.fromRGB(239, 216, 255)
            text.BorderSizePixel = 0
            text.Position = UDim2.new(1,10,0,0)
            text.Size = UDim2.new(0,0,1,0)
            text.Font = "Arial"
        ...
        function group:addList(args)
            ...
            listFrame.BorderColor3 = Color3.fromRGB(48, 34, 70)
			...
			local function updateValue(value)
				...
				if args.multiselect then
					...
					for i,v in next, listFrame:GetChildren() do
						...
						v.TextColor3 = Color3.fromRGB(239, 216, 255)
            ...
            function refresh(tbl)
                ...
                for i,v in pairs(tbl) do
                    ...
                    valueButton.BackgroundColor3 = Color3.fromRGB(56, 39, 80)
                    valueButton.TextColor3 = args.multiselect and Color3.fromRGB(239, 216, 255) or Color3.fromRGB(239, 216, 255)
